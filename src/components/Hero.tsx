...
const Hero = () => {
  return (
    <section className="relative  w-full h-screen py-12 md:py-0 md:px-4 ">
      <div className="z-10 relative px-4 md:top-1/3 md:w-1/2 text-pretty rounded-(--radius)  text-center md:text-left leading-relaxed *:py-2">
      ...
      <div className="inset-0 md:absolute z-0 px-4 rounded-(--radius)  ">
        <Image
          width={1200}
          height={700}
          loading="eager"
          ...
          aria-hidden={true}
          alt="Hero image"
          className="w-full sm:object-contain md:object object-[30%_0%] rounded-(--radius) "
        />
      </div>
    </section>
  );
